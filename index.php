...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Dreamday Planner</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Dreamday Planner</h1>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Family Name</span> / <span class="w-date">Date</span>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="w-like">
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/shreekar.jpeg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;>
                <span class="author">Shreekar Varpe </span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/aryan.jpeg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                <span class="author">Aryan Jadile</span>
              </div>
              <div class="content-test">
                <p class="description lead">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    ...
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>307, PVPIT Hostel, Bavdhan, Pune</li>
                      <li><span class="ion-ios-telephone"></span> 9404726449</li>
                      <li><span class="ion-email"></span> umeshwakadkar@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Dreamday Planner</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="#">Team Code Battalion</a>
              </div>
            </div>
          </div>
        </div>
